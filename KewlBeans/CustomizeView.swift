...
struct CustomizeView: View {
    ...
    var caffine: Int {
        var caffineAmount = drink.caffine[size]
        caffineAmount += (extraShots * 60)
    ...
    var body: some View {
        ...
        .toolbar {
            Button("Save") {
                history.add(drink, size: sizeOptions[size], extraShots: extraShots, isDecaf: isDecaf, milk: milk, syrup: syrup, caffine: caffine, calories: calories)
