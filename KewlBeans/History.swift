...
class History: ObservableObject {
    ...
    func add(_ drink: Drink, size: String, extraShots: Int, isDecaf: Bool, milk: ConfigurationOption, syrup: ConfigurationOption, caffine: Int, calories: Int) {
        var description = [String]()
        description.append(size)

        if isDecaf {
            description.append("decaffinated")
        }
        ...
        let serving = Serving(id: UUID(), name: drink.name, description: descriptionString, caffine: caffine, calories: calories)
